      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mx-auto max-w-3xl mb-20">
          <header className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/30 mb-6">
              ...
              <span className="text-sm font-medium text-blue-400">Free scan</span>
            </div>
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">
              Try it{' '}<span className="text-gradient">now</span>
            </h2>
            <p className="mt-4 text-lg text-slate-400">
              Enter any URL and get an instant accessibility report
            </p>
          </header>
          ...
          {isScanning && (
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="font-medium text-white">Scanning {url}</p>
                  <p className="text-sm text-slate-500">Checking WCAG 2.1 Level AA criteria...</p>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="text-center p-4 rounded-xl bg-amber-500/10">
                    ...
                    <div className="text-xs text-slate-500 mt-1">Serious</div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-blue-500/10 border border-blue-500/30">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-300">Sign up to see detailed issues and fixes</span>
                  </div>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-slate-400 mb-10 max-w-xl mx-auto">
            Join 5,000+ teams building inclusive digital experiences.
          </p>
          ...
          <p className="mt-6 text-sm text-slate-500">
            Free tier forever • WCAG 2.1 compliant • No credit card required
          </p>
        </div>
      </div>
    </section>

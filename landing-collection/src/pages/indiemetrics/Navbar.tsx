    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="glass border-b border-emerald-500/10">
        <nav className="container-custom flex h-16 items-center justify-between md:h-20">
          <Link to="/indiemetrics" className="flex items-center gap-2 text-xl font-bold">
            <TrendingUp className="h-6 w-6 text-emerald-500" /><span className="text-gradient">{COMPANY.name}</span>
          </Link>

...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="glass border-b border-rose-500/10">
        <nav className="container-custom flex h-16 items-center justify-between md:h-20">
          ...
          <button
            ...
            className="rounded-lg p-2 text-slate-400 hover:bg-rose-500/10 md:hidden"
        ...
        {isOpen && (
          <div className="border-t border-rose-500/10 px-4 py-4 md:hidden">

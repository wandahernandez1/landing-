...
import { useHeroAnimation, useFloatingAnimation } from '@/shared/hooks'
...
export function HeroSection() {
  ...
  useFloatingAnimation(sectionRef, '.floating-icon', { amplitude: 15, duration: 3 })
  useFloatingAnimation(sectionRef, '.coin-icon', { amplitude: 10, duration: 4 })
    ...
    >
      ...
      <div className="container-custom relative z-10 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p data-hero-description className="hero-subtitle mx-auto max-w-2xl text-lg text-navy-300 md:text-xl mb-10">
          ...
          <div data-hero-stats className="mt-16 flex flex-wrap items-center justify-center gap-8 text-navy-400">

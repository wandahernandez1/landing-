...
const BENCHMARKS = [
  ...
  { industry: 'News & Media', lcp: 3.2, cls: 0.18, inp: 220, bounceRate: 55 },
  { industry: 'SaaS', lcp: 2.4, cls: 0.08, inp: 150, bounceRate: 38 },
  { industry: 'Finance', lcp: 3.0, cls: 0.10, inp: 200, bounceRate: 45 },
]
    ...
    <section ref={sectionRef} id="testimonials" className="relative py-32 md:py-40">
      ...
      <div className="container-custom relative z-10">
        ...
        <header className="mx-auto mb-16 max-w-3xl text-center">
          <p className="mb-4 text-sm font-medium uppercase tracking-widest text-purple-400">ROI Calculator</p>
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
            Performance ={' '}<span className="text-gradient">Revenue</span>
          </h2>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/80 overflow-hidden">
            <div className="px-8 py-6 border-b border-slate-800 bg-slate-900">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-white">Revenue Impact Calculator</h3>
                </div>
                <button
            ...
            <div className="p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div>
                  <label className="block text-sm text-slate-400 mb-2">Monthly Visitors</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm text-slate-400 mb-2">Average Order Value ($)</label>
                  <input
                    type="number"
                    value={avgOrderValue}
                ...
                <div>
                  <label className="block text-sm text-slate-400 mb-2">Current Conversion (%)</label>
                  <input
                    type="number"
                    step="0.1"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-xl bg-slate-800/50 p-6 border border-slate-700">
                  <p className="text-sm text-slate-500 mb-2">Current Monthly Revenue</p>
                ...
                <div className="rounded-xl bg-green-500/10 p-6 border border-green-500/30">
                  <p className="text-sm text-green-400 mb-2">Projected with Optimization</p>
              ...
              <div className="mt-6 p-6 rounded-xl bg-purple-500/10 border border-purple-500/30">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-slate-400">Potential revenue increase</p>
        ...
        {/* Industry Benchmarks */}
        <div>
          <h3 className="text-2xl font-bold text-center text-white mb-8">Industry Benchmarks</h3>
          <div className="rounded-2xl border border-slate-800 bg-slate-900/80 overflow-hidden max-w-4xl mx-auto">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-900 border-b border-slate-800">
                    <th className="px-6 py-4 text-left text-sm font-medium text-slate-400">Industry</th>
                    ...
                    <th className="px-6 py-4 text-center text-sm font-medium text-slate-400">Bounce Rate</th>
                  </tr>
                </thead>

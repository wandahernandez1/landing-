...
const SESSION_FRAMES = [
  { action: 'Carga de página', element: 'Página principal', time: 0 },
  { action: 'Scroll', element: '50% de la página', time: 1.2 },
  { action: 'Hover', element: 'Tarjeta de precios', time: 2.8 },
  { action: 'Click', element: 'Botón CTA', time: 3.5 },
  { action: 'Rage click', element: 'Enlace roto', time: 4.2, isError: true },
  { action: 'Salida', element: 'Sale de página', time: 5.1, isError: true },
]

// Live metrics
const DASHBOARD_METRICS = [
  { label: 'Sesión Prom.', value: '2m 34s', change: '+12%', icon: Clock },
  { label: 'Tasa de Rebote', value: '34.2%', change: '-8%', icon: TrendingDown, isGood: true },
  { label: 'Conversiones', value: '847', change: '+23%', icon: BarChart3 },
  { label: 'Usuarios Activos', value: '1,234', change: '+156', icon: Users },
]
      ...
      <div className="container-custom relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-slate-400 mb-8">
                  El 67% de los visitantes se van sin convertir. Sin datos de comportamiento, estás adivinando por qué.
                </p>
                <div className="space-y-4">
                  {[
                    'Usuarios haciendo rage-click en elementos rotos',
                    'Formularios abandonados en el último paso',
                    'CTAs clave nunca vistos por profundidad de scroll',
                  ].map((problem, i) => (
              ...
              <div className="relative">
                <div className="space-y-2">
                  {[
                    { label: 'Visitantes', value: 10000, pct: 100 },
                    { label: 'Enganchados', value: 6700, pct: 67 },
                    { label: 'Interesados', value: 2800, pct: 28 },
                    { label: 'Convertidos', value: 340, pct: 3.4 },
                  ].map((step, i) => (
        ...
        <div className="mb-40">
          <header className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <h2 id="features-title" className="text-4xl font-bold tracking-tight sm:text-5xl">
              Observa cada viaje del usuario
            </h2>
          </header>
            ...
            <div className="rounded-2xl border border-rose-500/20 bg-slate-900/90 overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-slate-800/80 border-b border-slate-700/50">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs text-slate-500">Duración: 5.1s</span>
                  <button
              ...
              <div className="aspect-video bg-slate-950 relative flex items-center justify-center">
                <div className="absolute inset-4 border border-dashed border-slate-700/50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-slate-500">Simulación del viewport del usuario</p>
                  </div>
                </div>
        ...
        <div className="mb-40">
          <header className="mx-auto mb-12 max-w-3xl text-center">
            <h3 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Métricas en tiempo real que importan
            </h3>
          </header>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-3xl font-bold text-white mb-4">
                  La privacidad de tus usuarios es sagrada
                </h3>
                <p className="text-slate-400 mb-6">
                  Nunca comprometemos la privacidad. Insights completos sin la culpa.
                </p>
              </div>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: Cookie, label: 'Sin Cookies', desc: 'Sin cookies de rastreo' },
                  { icon: Lock, label: 'GDPR Listo', desc: 'Totalmente compatible' },
                  { icon: Shield, label: 'SOC 2', desc: 'Tipo II certificado' },
                  { icon: Eye, label: 'Anónimo', desc: 'PII oculto por defecto' },
                ].map((item) => (
        ...
        <div>
          <header className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="mt-4 text-slate-400">Integraciones perfectas con las herramientas que ya usas</p>
          </header>
